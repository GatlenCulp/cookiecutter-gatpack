"""Command-line plotting utilities for cookiecutter_gatpack.

Usage:
    $ python -m cookiecutter_gatpack.plots [--input-path PATH] [--output-path PATH]
"""
...
from cookiecutter_gatpack.config import FIGURES_DIR, PROCESSED_DATA_DIR
